<script>
    ...
    import nextLevelBg from "$lib/img/nextlevel/cryptocurrencyConcept/nextlevelbg.jpg"
    import pionexlogo from "$lib/img/nextlevel/pionext.jpg";
</script>

    
<div class="bg-white pt-14">
    <h1 class="pt-1 text-center font-bold text-base bg-primary-100 text-black z-50">❚█══𝙉𝙚𝙭𝙩 𝙇𝙚𝙫𝙚𝙡══█❚</h1>
</div>
...
<div style="" class="">
    ...
    <div class="px-4 pt-16 pb-4 text-center mb-10">
      <h1>
        <Indicator color="green" class="animate-pulse md:ml-10 lg:ml-32 xl:ml-60"/>
        <span class="font-extrabold text-2xl md:text-3xl lg:text-4xl xl:text-6xl text-lime-400  ">
