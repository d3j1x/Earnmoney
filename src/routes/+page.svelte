...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 m-5 xl:my-24">
  <div class="col-span-1 mx-auto md:my-20">
      <Card class="bg-transparent hover:backdrop-blur-sm shadow-primary-50 border-none backdrop-blur-none ">
          ...
          <h1 style="font-family: 'Courier New', Courier, monospace;" class="text-primary-100">Mobile | Desktop</h1>
          <a href="https://www.coinpayu.com/?r=d3j1x" target="_blank" rel="noreferrer" class="inline-flex items-center text-primary-50 hover:underline font-semibold">
            Join now
            <GiftBoxSolid class="w-4 h-4 ms-2.5" />
          </a>
      </Card>
  ...
  <div class="col-span-1 m-auto">
      <Card class="bg-transparent hover:backdrop-blur-sm shadow-primary-50 border-none backdrop-blur-none ">
          ...
          <h1 style="font-family: 'Courier New', Courier, monospace;" class="text-primary-100">Mobile | Desktop</h1>
          <a href="https://r.adbtc.top/3118297" target="_blank" rel="noreferrer" class="inline-flex items-center text-primary-50 hover:underline font-semibold">
            Join now
            <GiftBoxSolid class="w-4 h-4 ms-2.5" />
          </a>
      </Card>
  ...
  <div class="col-span-1 md:col-span-2 xl:col-span-1 m-auto">
    <Card class="bg-transparent hover:backdrop-blur-sm shadow-primary-50 border-none backdrop-blur-none">
        ...
        <h1 style="font-family: 'Courier New', Courier, monospace;" class="text-primary-100">Mobile | Desktop</h1>
        <a href="https://faucetpay.io/?r=4173092" target="_blank" rel="noreferrer" class="inline-flex items-center text-primary-50 hover:underline font-semibold">
          Join now
          <GiftBoxSolid class="w-4 h-4 ms-2.5" />
        </a>
    </Card>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 m-5 xl:my-24">
    ...
    <div class="col-span-1 md:col-span-2 xl:col-span-1 m-auto">
      <Card class="bg-transparent hover:backdrop-blur-sm shadow-primary-900 border-none backdrop-blur-none">
          ...
          <h1 style="font-family: 'Courier New', Courier, monospace;" class="text-primary-900">Mobile | Desktop</h1>
          <a href="https://simplebits.io/ref/L4tmvQbH1IOWy5ro" target="_blank" rel="noreferrer" class="inline-flex items-center text-primary-900 hover:underline font-semibold">
            Join now
            <GiftBoxSolid class="w-4 h-4 ms-2.5" />
          </a>
      </Card>
